	...
	function classInstanceCopy() 
	{
		...
		{	
			...
			#initialize = function(a,b,c)
			{
				...
				{						
					var cleanContextObject = {this$:this, "that":that, a:a, b:b, X:X, changeX:changeX, c:c, "PI":PI, "#F":this.#F};
		...
		// Also native type, and type symbol
		Object.defineProperty(foo.prototype, copySymbol,
		{
			value:function()
			{
				if(this.__proto__ === foo.prototype) return new foo(defaultConstructorSymbol);			
				if(this === foo.prototype) return this;
				return Object.create(Object.getPrototypeOf(this));	
			}
		});
		
		//Object.defineProperty(foo.prototype, typeSymbol,
		//{
		//	value:function()
		//	{
		//		if(this === foo.prototype) return "Object";
		...
		console.log("stringify(x, {doWriteGetsSets:true}) == stringify(z, {doWriteGetsSets:true}): " 
			+ (stringify(x, {doWriteGetsSets:true}) == stringify(z, {doWriteGetsSets:true})));
		compare(x,z);
